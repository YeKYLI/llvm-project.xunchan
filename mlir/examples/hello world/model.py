...
支撑文档： 龙书、还有小福推荐的基本C++书、、甚至指令集、或者干脆把小福推荐的书都放在这里吧
...
## 把全部优化都看一遍看有什么优化空间这部分遍历一下、最主要的是可以写到简历上

--------------------- 本次走到这里就行了、、后边有时间漫长的岁月再慢慢沉淀

# LLVM Committer

## 看一下LLVM还有什么不足的地方、还在发展的地方提交代码 成为Committer

前期尽量做一些可以写在简历上的事情


嵌入式是计算机科学界的生化环材、编译器是dirty work、System是秃头工程师、AI和Web3这种讲故事的才是18岁的处女

推理相关的工作就是 | 量化 + LLVM + 学术界的各种创新

有些问题只有大厂才会用到，但成长为大厂相关问题早已经不是问题了或者存储足够的技术储备，或者有足够多牛逼的人